    ...
    def loadWeeksWithChoreDays(self) -> None:
            ...
            for day in week.days:
                day.setChores(
                    [
                        ...
                        # Afternoon
                        Chore(idBase + 5, [UserNamesEnum.Luke], ChoreListEnum.FEED_BEAR_LUNCH, datetime(2022, 2, 7, 12, 00).time(), 60, True),
                        # Evening
                        Chore(idBase + 6, [UserNamesEnum.Luke], ChoreListEnum.CHECK_MAIL, datetime(2022, 2, 7, (4 + 12), 30).time(), 60, True),
        ...
        self.weeks[0].days[1].setChores(
            [
                ...
                # Chore(idBase + 2, [UserNamesEnum.Nat], ChoreListEnum.WIPE_LIVING_ROOM_TABLES, datetime(2022, 2, 7, (5 + 12), 30).time(), 2*60, False),
            ]
        )
        # idBase += 2
        # 1st Wednesday
        ...
        self.weeks[0].days[3].setChores(
            [
                ...
                # Chore(idBase + 2, [UserNamesEnum.James], ChoreListEnum.SWEEP_KITCHEN, datetime(2022, 2, 7, (5 + 12), 30).time(), 2*60, False),
                # Chore(idBase + 3, [UserNamesEnum.James], ChoreListEnum.MOP_KITCHEN, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),
                # Chore(idBase + 4, [UserNamesEnum.James], ChoreListEnum.SWEEP_HALLS_AND_HALF_BATH, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),
                # Chore(idBase + 5, [UserNamesEnum.James], ChoreListEnum.SWEEP_STAIRS, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),
                # Chore(idBase + 6, [UserNamesEnum.James], ChoreListEnum.SWEEP_FULL_BATH, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),
                # Chore(idBase + 7, [UserNamesEnum.James], ChoreListEnum.CLEAN_PUB_COUCH, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),

                # Nat
                # Chore(idBase + 8, [UserNamesEnum.Nat], ChoreListEnum.DO_HOUSE_LAUNDRY, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),
                # Chore(idBase + 9, [UserNamesEnum.Nat], ChoreListEnum.BEAT_FLOOR_MATS, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),
                # Chore(idBase + 10, [UserNamesEnum.Nat], ChoreListEnum.SWEEP_LIVING_R, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),
                # Chore(idBase + 11, [UserNamesEnum.Nat], ChoreListEnum.SWEEP_DINING_R, datetime(2022, 2, 7, (5 + 12), 0).time(), 2*60, False),
            ]
        )
        # idBase += 11
        # 1st Friday
        self.weeks[0].days[4].setChores(
            [
                ...
                # Chore(idBase + 3, [UserNamesEnum.James], ChoreListEnum.BURN_TRASH, datetime(2022, 2, 7, (5 + 12), 30).time(), 2*60, False),
                # Chore(idBase + 4, [UserNamesEnum.James], ChoreListEnum.BRING_IN_PUB_DISHES, datetime(2022, 2, 7, (10 + 12), 30).time(), 1*60, False),
            ]
        )
        # idBase += 4
        ...
        self.weeks[1].days[1].setChores(
            [
                ...
                # Chore(idBase + 4, [UserNamesEnum.James, UserNamesEnum.Nat], ChoreListEnum.COOK_DINNER, datetime(2022, 2, 7, (5 + 12), 30).time(), 4*60, False), 
            ]
        )
        idBase += 1
        # 2nd Wednesday
